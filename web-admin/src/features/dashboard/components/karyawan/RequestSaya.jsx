...
export default function RequestSaya() {
  ...
  if (isLoading) {
    return <LoadingBouncyArc text="Memuat request..." fullscreen />
  }

  return (
    <div className="w-full p-2 overflow-x-auto bg-gradient-to-br from-[#0A1E3A]/60 via-[#091A2E]/40 to-[#06142A]/30 backdrop-blur-xl border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.4)] rounded-2xl">
